class SynapseObject {
    ...
    static $AllowedTypes = @('integrationRuntime', 'pipeline', 'dataset', 'dataflow', 'linkedService', 'trigger', 'sqlscript', 'notebook', 'managedVirtualNetwork', 'managedPrivateEndpoint')
